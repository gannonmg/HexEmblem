...
public enum BAProcessedAnimationStore {
    ...
    public static func playableFrames(
        ...
        let frames: [BAPlayback.Frame] = try frameEvents.compactMap { frameEvent in
    ...
    private static func playbackLayerURLs(
        ...
        animationID: String
    ) throws(BAProcessedAnimationStoreError) -> BAPlayback.LayerURLs {
        switch assetPaths {
        case .main(let path):
